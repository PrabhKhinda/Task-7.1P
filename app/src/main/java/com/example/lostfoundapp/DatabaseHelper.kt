...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        val createTableQuery = "CREATE TABLE $TABLE_NAME ($COLUMN_ID INTEGER PRIMARY KEY AUTOINCREMENT, $COLUMN_TYPE TEXT, $COLUMN_NAME TEXT, $COLUMN_DESCRIPTION TEXT, $COLUMN_DATE TEXT, $COLUMN_LOCATION TEXT, $COLUMN_PHONE TEXT)"
    ...
    fun insertAdvert(type: String, name: String, description: String, date: String, location: String, phone: String): Long {
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    val advert = Advert(id, type, name, description, date, location, phone)
                    adsList.add(advert)
